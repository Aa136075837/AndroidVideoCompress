...
public class QqMerge implements MergeCallBack {
    ...
    public Bitmap merge(List<Bitmap> bitmapArray, Context context, ImageView imageView) {
        ...
        localCanvas.drawLine(imageView.getWidth() / 2, 0, imageView.getWidth() / 2, imageView.getHeight(), mLinePaint);

        localCanvas.drawLine(0, imageView.getHeight() / 2, imageView.getWidth(), imageView.getHeight() / 2, mLinePaint);
